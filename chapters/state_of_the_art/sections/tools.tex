...
\begin{itemize}
    ...
    It's used by Kubeflow for example to orchestrate MLOps pipelines.
...
Flux is another GitOps operator, Prometheus, OpenSearch, OpenMetadata, AirBytes, ElasticSearch,

Terraform can be used as a IAC tool to deploy a kubernetes cluster on any cloud provider.
classic python ml framworks/libraries scikit-learn, keras, tensorflow.